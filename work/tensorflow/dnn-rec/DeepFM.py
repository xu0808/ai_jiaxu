...
# 数据文件
data_dir = 'E:\\study\\rec\\SparrowRecSys-master\\src\\main\\resources\\webroot\\sampledata'
training_samples_file_path = os.path.join(data_dir, 'trainingSamples.csv')
test_samples_file_path = os.path.join(data_dir, 'testSamples.csv')
...
# fm first-order term columns: without embedding and concatenate to the output_0 layer directly
