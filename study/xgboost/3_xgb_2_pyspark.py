...
os.environ[
        'PYSPARK_SUBMIT_ARGS'] = '--jars xgboost4j-spark-0.72.jar,xgboost4j-0.72.jar pyspark-shell'  # 本地运行时，jar包放在当前代码的路径下；提交任务时，利用--jars参数指定
...
# sparkxgb.zip包路径，如果本地运行则改成本地路径
spark.sparkContext.addPyFile("D:\\study\\data\\xgb\\pyspark-main\\sparkxgb.zip")
