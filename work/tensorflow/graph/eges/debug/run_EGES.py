...
if __name__ == '__main__':
    ...
    parser.add_argument("--root_path", type=str, default='../data_1/')
    ...
    side_info = np.loadtxt(args.root_path + 'feature.csv', dtype=np.int32, delimiter='\t')
    all_pairs = np.loadtxt(args.root_path + 'sample_pairs.csv', dtype=np.int32, delimiter=' ')
    feature_lens = []
